...
/** @type {string} */
const CACHE_VERSION = '1762876609|395217987';
/** @type {string} */
const CACHE_PREFIX = 'Crosscat-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'cross_cat.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["cross_cat.html","cross_cat.js","cross_cat.offline.html","cross_cat.icon.png","cross_cat.apple-touch-icon.png","cross_cat.audio.worklet.js","cross_cat.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["cross_cat.wasm","cross_cat.pck"];
