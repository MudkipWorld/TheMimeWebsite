...
/** @type {string} */
const CACHE_VERSION = '1763500962|4578041662';
/** @type {string} */
const CACHE_PREFIX = 'Unique Aquarium-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'unique_aquarium.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["unique_aquarium.html","unique_aquarium.js","unique_aquarium.offline.html","unique_aquarium.icon.png","unique_aquarium.apple-touch-icon.png","unique_aquarium.audio.worklet.js","unique_aquarium.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["unique_aquarium.wasm","unique_aquarium.pck"];
